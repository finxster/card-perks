...
import { insertPerkSchema, type Perk, type Card, type Merchant } from '@shared/schema';
import { z } from 'zod';
...
interface EditPerkDialogProps {
  ...
  onEdit: (id: string, data: Partial<Perk>) => Promise<any>;
}
...
export function EditPerkDialog({ perk, cards, open, onOpenChange, onEdit }: EditPerkDialogProps) {
  ...
  const form = useForm<PerkFormData>({
    ...
    defaultValues: {
      ...
      cardId: perk.cardId || '',
      value: perk.value || '',
      merchantId: perk.merchantId,
      expirationDate: perk.expirationDate ? new Date(perk.expirationDate) : undefined,
      isPublic: perk.isPublic,
    },
  });
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-md max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Update the details of your perk or reward.
          </DialogDescription>
        </DialogHeader>
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-4">
            ...
            <div className="flex justify-end gap-2 pt-4">
              ...
              >
                {isSubmitting ? 'Updating...' : 'Update Perk'}
              </Button>
            </div>
          </form>
        </Form>
